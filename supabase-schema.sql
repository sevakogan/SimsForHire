...
CREATE TABLE projects (
  ...
  name TEXT NOT NULL,
  status TEXT NOT NULL DEFAULT 'draft' CHECK (status IN ('draft', 'quote', 'submitted', 'accepted', 'paid', 'preparing', 'shipped', 'received', 'completed', 'archived')),
  invoice_number TEXT,
  invoice_link TEXT,
  invoice_link_2 TEXT,
  date_required DATE,
  ...
  additional_discount NUMERIC(12, 2) NOT NULL DEFAULT 0,
