...
import { FulfillmentBadge, FULFILLMENT_CONFIG } from "@/components/ui/fulfillment-badge";
        ...
        <div className="space-y-4">
          ...
          <div className={formStyles.group}>
            ...
            <div className="grid grid-cols-3 gap-2">
              {(["delivery", "pickup", "white_glove"] as const).map((ft) => {
                const config = FULFILLMENT_CONFIG[ft];
                return (
                  <button
                    key={ft}
                    type="button"
