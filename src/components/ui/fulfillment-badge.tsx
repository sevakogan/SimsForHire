...
const FULFILLMENT_CONFIG: Record<string, { label: string; bg: string; icon: string }> = {
  delivery: {
    label: "Delivery",
...
/** Shared fulfillment config for use in edit modals / forms. */
export { FULFILLMENT_CONFIG };

export function FulfillmentBadge({ type }: { type: FulfillmentType | undefined }) {
  const config = FULFILLMENT_CONFIG[type ?? "delivery"] ?? FULFILLMENT_CONFIG.delivery;
