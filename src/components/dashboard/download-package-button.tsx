...
export function AdminDownloadPackageButton({
  ...
  }, [generating, invoiceData, receiptNumber]);
          ...
          <div style={{ maxWidth: "500px", margin: "0 auto" }}>
            ...
            {d.invoiceNumber && (
              <div style={{ display: "flex", justifyContent: "space-between", padding: "12px 0", borderBottom: "1px solid #f3f4f6", fontSize: "14px" }}>
                ...
                <span style={{ fontWeight: 700, color: "#111827" }}>{d.invoiceNumber}</span>
              </div>
            )}
            {paymentDate && (
              <div style={{ display: "flex", justifyContent: "space-between", padding: "12px 0", borderBottom: "1px solid #f3f4f6", fontSize: "14px" }}>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", padding: "12px 0", borderBottom: "1px solid #f3f4f6", fontSize: "14px" }}>
              ...
              <span style={{ fontWeight: 700, color: "#111827" }}>{d.buyerName}</span>
            </div>
            <div style={{ display: "flex", justifyContent: "space-between", padding: "12px 0", borderBottom: "1px solid #f3f4f6", fontSize: "14px" }}>
              <span style={{ color: "#6b7280" }}>Paid To</span>
              <span style={{ fontWeight: 700, color: "#111827" }}>{d.companyName}</span>
            </div>
            <div style={{ display: "flex", justifyContent: "space-between", padding: "12px 0", borderBottom: "1px solid #f3f4f6", fontSize: "14px" }}>
