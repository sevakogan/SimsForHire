...
const CLIENT_SAFE_COLUMNS =
  "id, project_id, item_number, item_type, description, item_link, retail_price, retail_shipping, discount_percent, price_sold_for, image_url, notes, created_at, updated_at";
